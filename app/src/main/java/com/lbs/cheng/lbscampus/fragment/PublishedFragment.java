...
public class PublishedFragment extends Fragment implements View.OnClickListener{
    ...
    private void initRecyclerView() {
        ...
        NoticeAdapter adapter = new NoticeAdapter(R.layout.item_notice,noticeList,getContext());
